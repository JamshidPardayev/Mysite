...
const LoginForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className=" flex flex-col gap-y-2 p-4 rounded">
      ...
      <input className='border outline-none h-[40px] px-2 rounded-[8px] border-gray-300' type="text" value={email} onChange={(e) => setEmail(e.target.value)} />
      <input className='border outline-none h-[40px] px-2 rounded-[8px] border-gray-300' type="text" value={password} onChange={(e) => setPassword(e.target.value)} />
